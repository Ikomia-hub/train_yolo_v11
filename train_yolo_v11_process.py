...
# --------------------
class TrainYoloV11Param(TaskParam):
...
# --------------------
class TrainYoloV11(dnntrain.TrainProcess):

    def __init__(self, name, param):
        dnntrain.TrainProcess.__init__(self, name, param)
        # Create parameters object
        if param is None:
            self.set_param_object(TrainYoloV11Param())
        else:
...
# --------------------
class TrainYoloV11Factory(dataprocess.CTaskFactory):

    def __init__(self):
        dataprocess.CTaskFactory.__init__(self)
        self.info.name = "train_yolo_v11"
        ...
        self.info.repository = "https://github.com/Ikomia-hub/train_yolo_v11"
    ...
    def create(self, param=None):
        ...
        return TrainYoloV11(self.info.name, param)
