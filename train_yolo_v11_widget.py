...
from train_yolo_v11.train_yolo_v11_process import TrainYoloV11Param
...
# --------------------
class TrainYoloV11Widget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = TrainYoloV11Param()
        else:
